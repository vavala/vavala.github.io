...
var tr = document.getElementsByClassName("text-brunovavala");
var i;for (i = 0; i < tr.length; i++) {tr[i].innerHTML = string_brunovavala;}
...
var tr = document.getElementsByClassName("text-twitter");
var i;for (i = 0; i < tr.length; i++) {tr[i].innerHTML = string_twitter;}

var tr = document.getElementsByClassName("text-publications");
var i;for (i = 0; i < tr.length; i++) {tr[i].innerHTML = string_publications;}

var tr = document.getElementsByClassName("text-contact");
var i;for (i = 0; i < tr.length; i++) {tr[i].innerHTML = string_contact;}